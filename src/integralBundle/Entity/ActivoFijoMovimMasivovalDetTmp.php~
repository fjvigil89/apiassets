...
/**
 * ActivoFijoMovimMasivovalDetTmp
 *
 * @ORM\Table(name="Activo_Fijo_Movim_MasivoVal_Det_Tmp")
 * @ORM\Entity
 */
class ActivoFijoMovimMasivovalDetTmp
{
    /**
     * @var integer
     *
     ...
     * @return ActivoFijoMovimMasivovalDetTmp
     */
