 ...
 * ChAliquidaciones
 *
 * @ORM\Table(name="CH_ALiquidaciones", indexes={@ORM\Index(name="Ix3_Liquid1", columns={"Id_Liquidacion", "Id_Agrupacion", "Ano"})})
 * @ORM\Entity
 */
class ChAliquidaciones
{
    /**
     * @var integer
     *
