 ...
 * ChAnticiposDet
 *
 * @ORM\Table(name="CH_Anticipos_Det", indexes={@ORM\Index(name="IX_Anticipos1_Det", columns={"Estado", "Id_Anticipo", "Fecha", "Id_Empleado"})})
 * @ORM\Entity
 */
class ChAnticiposDet
{
    /**
     * @var integer
     *
