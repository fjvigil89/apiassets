 ...
 * FormatoFinCxpVars
 *
 * @ORM\Table(name="Formato_Fin_CxP_Vars", indexes={@ORM\Index(name="Clu_Tipo_Fo_Nro_CxP", columns={"Tipo_Formato", "Numero_Formato"})})
 * @ORM\Entity
 */
class FormatoFinCxpVars
{
    /**
     * @var integer
     *
