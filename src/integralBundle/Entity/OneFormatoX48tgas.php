 ...
 * OneFormatoX48tgas
 *
 * @ORM\Table(name="ONE_Formato_x48TGas")
 * @ORM\Entity
 */
class OneFormatoX48tgas
{
    /**
     * @var integer
     *
     ...
     * @var integer
     *
     * @ORM\Column(name="Saldo_hFecha_Turquino", type="integer", nullable=false)
     */
    private $saldoHfechaTurquino;
    ...
    /**
     * Set saldoHfechaTurquino
     *
     * @param integer $saldoHfechaTurquino
     * @return OneFormatoX48tgas
     */
    public function setSaldoHfechaTurquino($saldoHfechaTurquino)
    {
        $this->saldoHfechaTurquino = $saldoHfechaTurquino;

        return $this;
    }

    /**
     * Get saldoHfechaTurquino
     *
     * @return integer 
     */
    public function getSaldoHfechaTurquino()
    {
        return $this->saldoHfechaTurquino;
    }
