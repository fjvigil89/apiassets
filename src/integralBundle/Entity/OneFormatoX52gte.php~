 ...
 * OneFormatoX52gte
 *
 * @ORM\Table(name="ONE_Formato_x52GTe")
 * @ORM\Entity
 */
class OneFormatoX52gte
{
    /**
     * @var integer
     *
     ...
     * @var integer
     *
     * @ORM\Column(name="Plan_Presup", type="integer", nullable=false)
     */
    private $planPresup;
     ...
     * @var integer
     *
     * @ORM\Column(name="Real_Presup", type="integer", nullable=false)
     */
    private $realPresup;
     ...
     * @var integer
     *
     * @ORM\Column(name="Plan_Turquino", type="integer", nullable=false)
     */
    private $planTurquino;

    /**
     * @var integer
     *
     * @ORM\Column(name="Real_Turquino", type="integer", nullable=false)
     */
    private $realTurquino;
     ...
     * Set planPresup
     *
     * @param integer $planPresup
     * @return OneFormatoX52gte
     */
    public function setPlanPresup($planPresup)
    {
        $this->planPresup = $planPresup;
     ...
     * @return integer 
     */
    public function getPlanPresup()
    {
        return $this->planPresup;
    }

    /**
     * Set realPresup
     *
     * @param integer $realPresup
     * @return OneFormatoX52gte
     */
    public function setRealPresup($realPresup)
    {
        $this->realPresup = $realPresup;
     ...
     * @return integer 
     */
    public function getRealPresup()
    {
        return $this->realPresup;
    }

    /**
     * Set planTurquino
     *
     * @param integer $planTurquino
     * @return OneFormatoX52gte
     */
    public function setPlanTurquino($planTurquino)
    {
        $this->planTurquino = $planTurquino;
     ...
     * @return integer 
     */
    public function getPlanTurquino()
    {
        return $this->planTurquino;
    }

    /**
     * Set realTurquino
     *
     * @param integer $realTurquino
     * @return OneFormatoX52gte
     */
    public function setRealTurquino($realTurquino)
    {
        $this->realTurquino = $realTurquino;
     ...
     * @return integer 
     */
    public function getRealTurquino()
    {
        return $this->realTurquino;
    }
