 ...
 * OneFormatoXk23erag
 *
 * @ORM\Table(name="ONE_Formato_xK23ERAg")
 * @ORM\Entity
 */
class OneFormatoXk23erag
{
    /**
     * @var integer
     *
     ...
     * @var integer
     *
     * @ORM\Column(name="Saldo_Ano_Ant", type="integer", nullable=false)
     */
    private $saldoAnoAnt;
     ...
     * @var integer
     *
     * @ORM\Column(name="Saldo_Ano_Act", type="integer", nullable=false)
     */
    private $saldoAnoAct;
     ...
     * Set saldoAnoAnt
     *
     * @param integer $saldoAnoAnt
     * @return OneFormatoXk23erag
     */
    public function setSaldoAnoAnt($saldoAnoAnt)
    {
        $this->saldoAnoAnt = $saldoAnoAnt;
     ...
     * @return integer 
     */
    public function getSaldoAnoAnt()
    {
        return $this->saldoAnoAnt;
    }
     ...
     * Set saldoAnoAct
     *
     * @param integer $saldoAnoAct
     * @return OneFormatoXk23erag
     */
    public function setSaldoAnoAct($saldoAnoAct)
    {
        $this->saldoAnoAct = $saldoAnoAct;
     ...
     * @return integer 
     */
    public function getSaldoAnoAct()
    {
        return $this->saldoAnoAct;
    }
