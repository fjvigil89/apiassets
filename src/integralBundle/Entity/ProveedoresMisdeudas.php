...
/**
 * ProveedoresMisdeudas
 *
 * @ORM\Table(name="Proveedores_MisDeudas", indexes={@ORM\Index(name="Ix_ProveeyFechaXX", columns={"Id_Proveedor", "Fecha"})})
 * @ORM\Entity
 */
class ProveedoresMisdeudas
{
    /**
     * @var integer
     *
