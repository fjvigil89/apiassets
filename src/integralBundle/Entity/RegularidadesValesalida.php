 ...
 *
 * @ORM\Table(name="Regularidades_ValeSalida", indexes={@ORM\Index(name="IX_Regularidades_ValeSalida", columns={"items"})})
 * @ORM\Entity
 */
class RegularidadesValesalida
{
    /**
     * @var string
     *
     ...
     * @var string
     *
     * @ORM\Column(name="Tipo_Doc", type="string", length=2, nullable=false)
     */
    private $tipoDoc;
     ...
     * @var string
     *
     * @ORM\Column(name="Destino", type="string", length=2, nullable=false)
     */
    private $destino;
     ...
     * @var string
     *
     * @ORM\Column(name="PORCIENTO", type="decimal", precision=18, scale=0, nullable=false)
     */
    private $porciento;
     ...
     * @return RegularidadesValesalida
     */
