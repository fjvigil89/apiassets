 ...
 *
 * @ORM\Table(name="RH_Detalles_Reporte_PreNomina_Aus", indexes={@ORM\Index(name="IX_RH_Detalles_Reporte_PreNomina_Aus", columns={"Contador"})})
 * @ORM\Entity
 */
class RhDetallesReportePrenominaAus
{
    /**
     * @var integer
     *
     ...
     * @return RhDetallesReportePrenominaAus
     */
