...
/**
 * RhTmpContabilizacionDeduccNominillasSubsidios
 *
 * @ORM\Table(name="RH_Tmp_Contabilizacion_Deducc_Nominillas_Subsidios")
 * @ORM\Entity
 */
class RhTmpContabilizacionDeduccNominillasSubsidios
{
    /**
     * @var string
     *
     ...
     * @return RhTmpContabilizacionDeduccNominillasSubsidios
     */
