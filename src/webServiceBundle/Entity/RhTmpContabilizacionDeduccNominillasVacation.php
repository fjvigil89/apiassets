...
/**
 * RhTmpContabilizacionDeduccNominillasVacation
 *
 * @ORM\Table(name="RH_Tmp_Contabilizacion_Deducc_Nominillas_Vacation")
 * @ORM\Entity
 */
class RhTmpContabilizacionDeduccNominillasVacation
{
    /**
     * @var string
     *
     ...
     * @return RhTmpContabilizacionDeduccNominillasVacation
     */
