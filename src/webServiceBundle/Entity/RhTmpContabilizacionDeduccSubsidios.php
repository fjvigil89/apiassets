...
/**
 * RhTmpContabilizacionDeduccSubsidios
 *
 * @ORM\Table(name="RH_Tmp_Contabilizacion_Deducc_Subsidios")
 * @ORM\Entity
 */
class RhTmpContabilizacionDeduccSubsidios
{
    /**
     * @var string
     *
     ...
     * @return RhTmpContabilizacionDeduccSubsidios
     */
